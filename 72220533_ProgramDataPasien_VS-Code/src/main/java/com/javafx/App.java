...
public class App extends Application {
    ...
    public boolean cekField() {
        boolean cek = false;
        if (fieldKodePasien.getText()!="") {
            if (fieldNama.getText()!="") {
                if (fieldAlamat.getText()!="") {
                    if (fieldKeluhan.getText()!="") {
                        cek = true;
                    }
                }
            }
        ...
        btnTambah.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if (cekField()) {
                    ...
                    if (fieldKodePasien.getText()=="") {
                        fieldKodePasien.requestFocus();
                    }else if (fieldNama.getText()=="") {
                        fieldNama.requestFocus();
                    }else if (fieldAlamat.getText()=="") {
                        fieldAlamat.requestFocus();
                    }else if (fieldKeluhan.getText()=="") {
